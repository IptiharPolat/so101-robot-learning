...
|---|---|---|---|
| `act_single_cube_success.gif` | Earlier single-cube ACT evaluation `eval_act_so101_grasp_100_v3_20`, `ep00` (0.00-29.40 s), front camera | Full episode, 2x speed, 8 FPS, 360 px wide | Representative single colored-box grasp-and-place example from the earlier ACT project. This is separate from the later two-cube ordering ACT experiment. |
...
| `smolvla_20k_cyan_then_pink.gif` | `recovery20k_l2_m09_c2p_formal_001`, front camera, 58.97 s | Full rollout, 3x speed, 8 FPS, 360 px wide | Operator-reported Cyan -> Pink success with both cubes visible in the center target area at the end. This is a qualitative capability example. |
